...
public:
	...
	uint8_t begin(const char *ssid, const char * user, const char *key);
	...
	uint8_t begin(const String &ssid, const String &user, const String &key) { return begin(ssid.c_str(), user.c_str(), key.c_str()); }
